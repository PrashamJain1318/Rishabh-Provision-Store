...
const allNavItems: SidebarItemData[] = [
  ...
  { id: "inventory", label: "Inventory Audit", iconName: "inventory", path: "/dashboard/inventory", roles: ["Owner", "Manager"] },
  { id: "purchases", label: "Purchases Inward", iconName: "inventory", path: "/dashboard/purchases", roles: ["Owner", "Manager"] },
